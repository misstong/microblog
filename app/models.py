    ...
    def to_collection_dict(query,page,per_page,endpoint,**kwargs):
        ...
        data = {
            ...
            '_links':{
                ...
                'prev':url_for(endpoint,page=page-1,per_page=per_page,**kwargs) if resource.has_perv else None
            }
...
class User(PaginatedAPIMixin,UserMixin, db.Model):
    ...
    def revoke_token(self):
        self.token_expiration = timedelta(seconds=1)
